class Match:
    ...
    def afficher_match(self, numero_match):
        print(
            ...
            f"Premier Joueur: {self.joueur1} \n"
            f"Second Joueur : {self.joueur2}\n"
            f"Score {self.joueur1}: {self.score_joueur1}\n"
            f"Score {self.joueur2}: {self.score_joueur2}"
        )
    ...
    def match_serialized(self):
        ...
        infos_match["joueur1"] = f"{self.nom_joueur1}"
        infos_match["score_joueur1"] = self.score_joueur1
        infos_match["joueur2"] = f"{self.nom_joueur2}"
